...
CONFIGS="alon_configs/data/pile.yml alon_configs/init.yml alon_configs/models/1B_seqlen2048_unnamed_train_datasets.yml alon_configs/eval_tasks.yml alon_configs/train_data_weights/static_1B_mean.yml"
# Doesn't include alon_configs/parallelism.yml

WANDB_GROUP="1B_seqlen2048_static_1B_mean"
