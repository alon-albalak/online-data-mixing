...
CONFIGS="alon_configs/data/pile.yml alon_configs/init.yml alon_configs/models/3B.yml alon_configs/eval_tasks.yml alon_configs/train_data_weights/original_pile.yml"
# Doesn't include alon_configs/parallelism.yml

WANDB_GROUP="3B_ods_smoothed_mean_mixed_minibatches_original_weights_init_05smoothing"
