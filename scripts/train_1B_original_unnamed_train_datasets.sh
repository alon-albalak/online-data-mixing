...
CONFIGS="alon_configs/data/pile.yml alon_configs/init.yml alon_configs/models/1B_unnamed_train_datasets.yml alon_configs/eval_tasks.yml alon_configs/train_data_weights/original_pile.yml"
