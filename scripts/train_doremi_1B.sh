...
CONFIGS="alon_configs/data/pile.yml alon_configs/init.yml alon_configs/optimizer.yml alon_configs/train_data_weights/doremi_1B.yml"
# Doesn't include alon_configs/eval_tasks.yml or  alon_configs/parallelism.yml

# RUN SPECIFIC CONFIGS
CONFIGS_160M="alon_configs/models/160m.yml alon_configs/run_specific/160m_doremi_1B.yml"
CONFIGS_410M="alon_configs/models/410m.yml alon_configs/run_specific/410m_doremi_1B.yml"
CONFIGS_1B="alon_configs/models/1B.yml alon_configs/run_specific/1B_doremi_1B.yml"
